		...
		return (
			<div className="flex flex-col px-2 sm:px-32 py-2">
				...
				<h2 className="text-mnd text-center py-1">
					No need to enter password, you can just login by clicking
					act as button
				</h2>
										...
										<tr key={index}>
											...
											<td className="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
												<button
													...
													className="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-white bg-stone-800 px-4 py-1 disabled:opacity-50 disabled:pointer-events-none dark:text-blue-500 dark:hover:text-blue-400 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
												>
													Act as
												</button>
											</td>
